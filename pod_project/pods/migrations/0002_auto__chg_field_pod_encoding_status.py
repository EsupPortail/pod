...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Pod.encoding_status'
        db.alter_column(u'pods_pod', 'encoding_status', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

    def backwards(self, orm):

        # Changing field 'Pod.encoding_status'
        db.alter_column(u'pods_pod', 'encoding_status', self.gf('django.db.models.fields.CharField')(default='', max_length=250))
