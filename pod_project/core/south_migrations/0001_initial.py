...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FileBrowse'
        db.create_table(u'core_filebrowse', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('document', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.File'], null=True, blank=True)),
        ))
        db.send_create_signal(u'core', ['FileBrowse'])

        # Adding model 'PagesMenuBas'
        db.create_table(u'core_pagesmenubas', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'core', ['PagesMenuBas'])
        ...
        db.create_table(u'core_userprofile', (
            ...
            ('auth_type', self.gf('django.db.models.fields.CharField')(default=u'loc.', max_length=20)),
            ('affiliation', self.gf('django.db.models.fields.CharField')(default=u'member', max_length=50)),
            ('commentaire', self.gf('django.db.models.fields.TextField')(default=u'', blank=True)),
        ))
        db.send_create_signal(u'core', ['UserProfile'])

        # Adding model 'EncodingType'
        db.create_table(u'core_encodingtype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=250)),
            ('bitrate_audio', self.gf('django.db.models.fields.CharField')(max_length=250)),
            ('bitrate_video', self.gf('django.db.models.fields.CharField')(max_length=250, blank=True)),
            ('output_height', self.gf('django.db.models.fields.IntegerField')(default=240, max_length=4)),
            ('mediatype', self.gf('django.db.models.fields.CharField')(default=u'video', max_length=5)),
        ))
        db.send_create_signal(u'core', ['EncodingType'])


    def backwards(self, orm):
        # Deleting model 'FileBrowse'
        db.delete_table(u'core_filebrowse')

        # Deleting model 'PagesMenuBas'
        db.delete_table(u'core_pagesmenubas')

        # Deleting model 'UserProfile'
        db.delete_table(u'core_userprofile')

        # Deleting model 'EncodingType'
        db.delete_table(u'core_encodingtype')
    ...
    models = {
        ...
        u'core.filebrowse': {
            'Meta': {'object_name': 'FileBrowse'},
            'document': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['filer.File']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'core.pagesmenubas': {
            'Meta': {'ordering': "[u'order', u'page__title']", 'object_name': 'PagesMenuBas'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1', 'null': 'True', 'blank': 'True'}),
            'page': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['flatpages.FlatPage']"})
        },
        u'core.userprofile': {
            'Meta': {'ordering': "(u'user',)", 'object_name': 'UserProfile'},
            'affiliation': ('django.db.models.fields.CharField', [], {'default': "u'member'", 'max_length': '50'}),
            'auth_type': ('django.db.models.fields.CharField', [], {'default': "u'loc.'", 'max_length': '20'}),
            'commentaire': ('django.db.models.fields.TextField', [], {'default': "u''", 'blank': 'True'}),
