...
class TestStoragePath(TestCase):
    ...
    def test_get_media_guard(self):
        media_guard_hash = get_media_guard("remi", self.video1.id)
        self.assertEqual(
            media_guard_hash, "df880ec636fe3a9dd39a33609dc44635a7c19d7b7b46deba33c281cf2edf0ca5")

    @override_settings(MEDIA_GUARD=True, MEDIA_GUARD_SALT="S3CR3T")
    def test_get_storage_path_video_with_media_guard(self):
        storage_path_1 = get_storage_path(self.video1, self.path1)
        self.assertEquals(
            storage_path_1, "videos/remi/df880ec636fe3a9dd39a33609dc44635a7c19d7b7b46deba33c281cf2edf0ca5/" + self.path1)
        storage_path_2 = get_storage_path(self.video2, self.path2)
        self.assertEquals(
            storage_path_2, "videos/remi/a1b11067d34f07639d40f411bbf70c2a601a464799699fb1af370f7bf24cb79c/" + self.path2)
